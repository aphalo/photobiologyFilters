...
\title{\PBFil Version 0.1.6\\ Catalogue of filters}
...
print(fig_linear + stat_peaks(span=71, ignore_threshold=0.25, colour="red", hjust=0, angle=90) + stat_valleys(span=51, ignore_threshold=-0.5, colour="blue", hjust=0, angle=90))
# print(fig_log)
}
@
