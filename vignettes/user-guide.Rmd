...
measured without an integrating sphere; i.e. only by assesing the direct beam.
...
upon exposure to light and UV radiaition, and in some cases even upon
...
Antireflection coating (ARC) reduces reflections, and multicoating (MC) even
...
the material as reference (i.e. discounting reflection). 1) is referref as
