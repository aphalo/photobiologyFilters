...
The vector `all_accessors` contains the names of the different vectors of
...
In addition to the predefined vactors it is possible to compute numeric indexing vectors
