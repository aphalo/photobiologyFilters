#' Total transmittance for UQG filters
#'
#' Total transmittance for UQG optical glass absorptive and interference
#' (dichroic) filters. Data measured by P. J. Aphalo with an Agilet 8453 array
#' spectrophotometer. Some of the filters are Schott glass and we have retained
#' the Schott type names.
#'
#' The variables are as follows:
#'
#' \itemize{ \item w.length (nm) \item Tfr (fraction) }
#'
#' @note Filter supplier: UQG Ltd. The Norman Industrial Estate, Milton,
#'   Cambridge, England. \url{https://www.uqgoptics.com/}
#'
#' @section DISCLAIMER: These spectral transmittance data are based on the
...
#'   The characterisitics of some types of glass filters may change with time
